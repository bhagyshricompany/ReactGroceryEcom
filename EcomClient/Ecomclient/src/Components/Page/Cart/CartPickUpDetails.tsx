...
// import LoyalityCart from "./LoyalityCart";
...
export default function CartPickUpDetails() {
  ...
  // if (includeLoyalty) {
  //   grandTotal += 417.73; // Add the fixed loyalty card value
  // }
  ...
  return (
    <div className="border pb-5 pt-3">
      ...
      <form onSubmit={handleSubmit} className="col-10 mx-auto">
        ...
        {/* <div className="form-group mt-3">
          <LoyalityCart onIncludeLoyalty={handleIncludeLoyalty} />
        </div> */}
        <div className="form-group mt-3">
